<template>
  ...
  >
    ...
    >
      <span
        class="absolute top-1/2 left-1/2 h-2.5 w-1.5 border-r-2 border-b-2 border-[var(--cml-color-current-on-color)] transition-opacity duration-200 [transform:translate(-50%,-60%)_rotate(45deg)]"
        :class="modelValue ? 'opacity-100' : 'opacity-0'"
      />
      <span
        class="absolute top-1/2 left-1/2 h-0.5 w-2.5 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[var(--cml-color-current-on-color)] transition-opacity duration-200"
