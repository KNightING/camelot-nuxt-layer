<template>
  <button
    class="group block cursor-pointer border-none bg-transparent p-0 outline-none disabled:cursor-not-allowed"
    :disabled="disabled"
