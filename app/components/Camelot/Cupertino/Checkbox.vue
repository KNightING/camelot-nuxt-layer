<template>
  ...
  >
    ...
    >
      <div
        class="absolute top-1/2 left-1/2 h-2 w-3 border-b-2 border-l-2 border-[var(--cml-color-current-on-color)] transition-opacity duration-200 [transform:translate(-50%,-65%)_rotate(-45deg)]"
